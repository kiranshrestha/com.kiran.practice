...
abstract class absdetail{
    ...
    abstract public void setFather(String father);
}
...
public class StudentProblem {
    public static void main(String[] args) throws IOException {
        ...
        if(n==r1.getANo()) {
            ...
            System.out.println("You will graduate in " + r1.getYear()+ " years");
        }
        else if(n==r2.getANo()){
            System.out.println(r2.getName() +" "+ r2.getptage() + " "+b2.getroute()+ " "+b2.getFather());
            System.out.println("You will graduate in " + r2.getYear()+ " years");
        }
        else
